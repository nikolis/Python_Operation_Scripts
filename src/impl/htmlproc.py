...
def _extract_ingredients_from_list(ulist):
    ...
    for item in listItems:
        ...
        get_ingredient_from_children(children)
        print ("-------")
        stringItem = str(item)
...
def get_ingredient_from_children(children):
    ...
    for child in children:
        ...
        if (childNum ==1):
            ingredientEntry = find_combined_quantity(child)
            print(ingredientEntry)
...
def __encode_escape_chars(string):
    ...
    for ch in escapeCharacters:
        ...
        while(index != -1):
            ...
            base64encoded_points.append(str(base64.b64encode(bytes(tempString[index:index+len(ch)], 'utf-8'))))
...
#print(" 4 x 300g/10wr0=oz aged")
#print(get_rid_of_backslashes(" 4 x 300g/10wr0=oz aged"))
